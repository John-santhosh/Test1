...
document.write('<h1 class="center">')
...
let result = [];
let rating = superMarket.filter(a=> a.rating<2)
for (let each in rating){
    // console.log(`product ${+each+1}`)
    result.push([`<h3> product ${+each+1} </h3> <br>`])
    for (let deep in rating[each]){
        // console.log(deep," : ",rating[each][deep])
        result.push([deep," : ",rating[each][deep],"<br>"])
...
document.write("<h2>")
document.write("1. Filter the elements with rating < 2")
document.write("</h2>")
document.write("<p>")
document.write(result.join(",").replaceAll(",", ""))
document.write("</p>")

//<=-=-=->2. Filter the elements with type 'dairy'</=-=-=->

let type = superMarket.filter(a=>a.type =="dairy")
let i = 1, resultType= [];
for (let each of type){
    // console.log(`product ${i}`)
    resultType.push([`<h3>product ${i} </h3>`,"<br>"])
    i++;
    for (let deep in each){
        // console.log(deep, " : ", each[deep], "<br>")
        resultType.push([deep, " : ", each[deep]],"<br>")
    }
}

document.write("<h2>")
document.write("2. Filter the elements with type 'dairy'")
document.write("</h2>")
document.write("<p>")
document.write(resultType.join(",").replaceAll(",", ""))
document.write("</p>")

//<=-=-=->3. Filter the elements with price >20</=-=-=->

let price = superMarket.filter(a=>a.price>20)
let j = 1, resultPrice= [];
for (let each of price){
    // console.log(each)
    resultPrice.push([`<h3>product ${j} </h3>`,"<br>"])
    j++;
    for (let deep in each){
        // console.log(deep, " : ", each[deep], "<br>")
        resultPrice.push([deep, " : ", each[deep]],"<br>")
    }
}

document.write("<h2>")
document.write("3. Filter the elements with price >20")
document.write("</h2>")
document.write("<p>")
document.write(resultPrice.join(",").replaceAll(",", ""))
document.write("</p>")

//<=-=-=->4. Filter the elements with title which contains the word ‘with’</=-=-=->

let title = superMarket.filter(a=>a.title.includes("with"))

let titleResult= [];

for (let each in title){
    // console.log(title[each])
    titleResult.push([`<h3>product ${+each+1} </h3>`,"<br>"])

    for(let deep in title[each]){
        // console.log(deep,title[each][deep])
        titleResult.push([deep, " : ", title[each][deep]],"<br>")
    }
}
...
document.write("<h2>")
document.write("4. Filter the elements with title which contains the word 'with'")
document.write("</h2>")
document.write("<p>")
document.write(titleResult.join(",").replaceAll(",", ""))
document.write("</p>")

//<=-=-=-> 5. Filter the elements with description which contains the word ‘with’<=-=-=->

let desc= superMarket.filter(a=> a.description.includes("with"))

let resultDesc = [];

for (let each in desc){
    resultDesc.push(`<h3> product ${+each+1} </h3> <br>`)
    for (let deep in desc[each]){
        resultDesc.push([deep," : ", desc[each][deep], "<br>"])
    }
}
...
document.write("<h2>")
document.write("5. Filter the elements with description which contains the word 'with'")
document.write("</h2>")
document.write("<p>")
document.write(resultDesc.join(",").replaceAll(",", ""))
document.write("</p>")
...
let resultMeasures = [];
for (let each in measures){
    // console.log(each)
    resultMeasures.push(`<h3>Product ${+each+1}</h3> <br>`)
    for (let deep in measures[each]){
        // console.log(deep)
        resultMeasures.push([deep," : ",measures[each][deep],"<br>"])
    }
}

document.write("<h2>")
document.write("6. Filter the elements with height = 600 and width = 400")
document.write("</h2>")
document.write("<p>")
