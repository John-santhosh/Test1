...
let averageRating = superMarket.reduce((prev,curr)=>{
    return curr.rating+prev
},0)
let totalStocks = superMarket.length
document.write("<h3>","1. Calculate the averageRatings of all the element","</h3>")
document.write("<br>","Average rating of an item is ",averageRating/totalStocks)
document.write("<br>")

// 2. Calculate the averageHeight of all the element

let averageHeight = superMarket.reduce((prev,curr)=>curr.height+prev,0)
document.write("<h3>","2. Calculate the averageHeight of all the element","</h3>")
document.write("<br>","Average height of an item is ",Math.floor(averageHeight/totalStocks))
document.write("<br>")

// 3. Calculate the averageWidth of all the element

let averageWidth = superMarket.reduce((prev,curr)=> curr.width+prev,0)
document.write("<h3>","3. Calculate the averageWidth of all the element","</h3>")
document.write("<br>","Average width of an item is ",Math.floor(averageWidth/totalStocks))
document.write("<br>")

// 4. Calculate the averagePrice of all the element

let averagePrice = superMarket.reduce((prev, curr)=> curr.price+prev,0)
document.write("<h3>","4. Calculate the averagePrice of all the element","</h3>")
document.write("<br>","Average price of an item is $ ",Math.floor(averagePrice/totalStocks))
document.write("<br>")
