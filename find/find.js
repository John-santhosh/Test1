...
let findRating = superMarket.find(function(a){
    return a.rating>=3
})
let findRatingResult = []
for (let rate in findRating){
    findRatingResult.push ([rate ," : ",findRating[rate],"<br>"])
}


document.write("<h2>")
document.write("1. Find the element with rating >= 3")
document.write("</h2>")
// document.write("<br>")
document.write("<p>")
document.write(findRatingResult.join("").replaceAll(",",""))
document.write("</p>")


//<=-=-=-=> 2. Find the element with type ‘vegetable’ <=-=-=-=>

let type = superMarket.find(a=> a.type=="vegetable")
let typeResult = []

for (let each in type){
typeResult.push(each ," : ",type[each], "<br>")
}

document.write("<h2>")
document.write("2. Find the element with type 'vegetable'")
document.write("</h2>")
document.write(typeResult.join(", ").replaceAll(",",""))

// <=-=-=-=> 3. Find the element with price < 15 <=-=-=-=>

let price = superMarket.find(a=> a.price<15)
let priceResult= [];

for (let each in price){
    priceResult.push([each , " : ", price[each],"<br>"])
}

document.write("<h2>")
document.write("3. Find the element with price < 15")
document.write("</h2>")
document.write(priceResult.join(",").replaceAll(",",""))

// <=-=-=-=> 4. Find the element with title which contains the word ‘Lemon’ <=-=-=-=>

let title = superMarket.find(a=> a.title.startsWith("Lemon"))

let titleResult = [];

for (let each in title){
    titleResult.push([each, " : ", title[each], "<br>"])
}

document.write("<h2>")
document.write("4. Find the element with title which contains the word 'Lemon'")
document.write("</h2>")
document.write(titleResult.join(",").replaceAll(",",""))

//<=-=-=-=> 5. Find the element with height = 450 and width = 450 <=-=-=-=>

let measures = superMarket.find(a => a.width== 450 || a.height == 450)

measuresResult = []

for (let each in measures){
    measuresResult.push([each, " : ", measures[each], "<br>"])
}

document.write("<h2>")
document.write("5. Find the element with height = 450 and width = 450")
document.write("</h2>")
document.write(measuresResult.join(",").replaceAll(",",""))
